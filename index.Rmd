---
title: "Data Analysis of Voting in Florida"
---

<center>

![](/Users/mfigaro/Documents/STA 5104 Project/voting-project/white_house.png)
...
#
## Related Work
#### Watching the 2020 Presidential Election unfold was what inspired me to do this project. Leading up to election night, and for days afterwards, news casters and analysts were discussing each condidate's appeal to minority voters, especially latino and black voters, elderly voters, and college educated voters. Americans are often very politically divided along these racial, eceonomic, and generational divides. How these demographics actually influenced voting motivated me to do this project.
#
## Initial Questions
...
![](/Users/mfigaro/Documents/STA 5104 Project/voting-project/florida_election_results.png)
...
```{r echo=FALSE}
plot(ElectionResults_2012)
plot(ElectionResults_2016)
```

## Percentage Vote Data

### 2012 Election
```{r Percentage graph/table 2012, echo=FALSE}
Total_Votes_display2012<-VoteData_2012%>%summarise(total=REPVotes_2012+
                            DEMVotes_2012+
                              OtherVotes_2012)
Total_Votes_display2016<-VoteData_2016%>%summarise(total=REPVotes_2016+
                            DEMVotes_2016+
                              OtherVotes_2016)
VoteData_2012_display<-VoteData_2012 %>% summarise(
  County=County_Names,
  Romney_Votes=(REPVotes_2012/Total_Votes_display2012)*100,
  Obama_Votes=(DEMVotes_2012/Total_Votes_display2012)*100)

VoteData_2012_display <- data.frame(VoteData_2012_display$County,VoteData_2012_display$Romney_Votes,VoteData_2012_display$Obama_Votes)

VoteData_2016_display<-VoteData_2016 %>% summarise(
  County=County_Names,
  Trump_Votes=(REPVotes_2016/Total_Votes_display2016)*100,
  Clinton_Votes=(DEMVotes_2016/Total_Votes_display2016)*100)

VoteData_2016_display <- data.frame(VoteData_2016_display$County,VoteData_2016_display$Trump_Votes,VoteData_2016_display$Clinton_Votes)

ggplot(VoteData_2012_display,aes(x=reorder(VoteData_2012_display.County,total)))+
  geom_bar(aes(y=total),stat="identity")+
  theme(axis.text.x=element_text(angle=60, hjust=1))+
  labs(title="Percentage of Republican Votes in each County 2012",x="Counties",y="% REP Votes")

ggplot(VoteData_2012_display,aes(x=reorder(VoteData_2012_display.County,total.1)))+
  geom_bar(aes(y=total.1),stat="identity")+
  theme(axis.text.x=element_text(angle=60, hjust=1))+
  labs(title="Percentage of Democrat Votes in each County 2012",y="% DEM Votes",x="Counties")

table2012 <- VoteData_2012_display %>% summarise("County" = VoteData_2012_display.County,"REP % (Trump)" = total,"DEM % (Clinton)" = total.1)
knitr::kable(table2012,format="markdown")

```

#
### 2016 Election
```{r percentage graph/table 2016, echo=FALSE}
ggplot(VoteData_2016_display,aes(x=reorder(VoteData_2016_display.County,total)))+
  geom_bar(aes(y=total),stat="identity")+
  theme(axis.text.x=element_text(angle=60, hjust=1))+
  labs(title="Percentage of Republican Votes in each County 2016",y="% REP Votes",x="Counties")

ggplot(VoteData_2016_display,aes(x=reorder(VoteData_2016_display.County,total.1)))+
  geom_bar(aes(y=total.1),stat="identity")+
  theme(axis.text.x=element_text(angle=60, hjust=1))+
  labs(title="Percentage of Democrat Votes in each County 2016",y="% DEM Votes",x="Counties")

table2016 <- VoteData_2016_display %>% summarise("County" = VoteData_2016_display.County,"REP % (Trump)" = total,"DEM % (Clinton)" = total.1)
knitr::kable(table2016,format="markdown")
```
...
demog_white_plot<-ggplot(data=Pop_data_white_county,aes(x=County,y=Percentage))+
  ...
  theme(axis.text.x=element_text(angle=60, hjust=1))+
  labs(title="Percentage of White People",
...
demog_na_plot<-ggplot(data=Pop_data_na_county,aes(x=County,y=Percentage))+
  ...
  theme(axis.text.x=element_text(angle=60, hjust=1))+
  labs(y="Percentage of Population (%)",
       title="Percentage of Native Americans")
...
demog_asian_plot<-ggplot(data=Pop_data_asian_county,aes(x=County,y=Percentage))+
  ...
  theme(axis.text.x=element_text(angle=60, hjust=1))+
  labs(y="Percentage of Population (%)",
       title="Percentage of Asian People")
...
demog_pi_plot<-ggplot(data=Pop_data_pi_county,aes(x=County,y=Percentage))+
  ...
  theme(axis.text.x=element_text(angle=60, hjust=1))+
  labs(y="Percentage of Population (%)",
       title="Percentage of Pacific Islanders")
...
demog_latino_plot<-ggplot(data=Pop_data_latino_county,aes(x=County,y=Percentage))+
  ...
  theme(axis.text.x=element_text(angle=60, hjust=1))+
  labs(y="Percentage of Population (%)",
       title="Percentage of Latino People")
...
demog_sc_plot<-ggplot(data=Pop_data_sc_county,aes(x=County,y=Percentage))+
  ...
  theme(axis.text.x=element_text(angle=60, hjust=1))+
  labs(y="Percentage of Population (%)",
       title="Percentage of Senior Citizens")
...
demog_grad_plot<-ggplot(data=Pop_data_grad_county,aes(x=County,y=Percentage))+
  ...
  theme(axis.text.x=element_text(angle=60, hjust=1))+
  labs(y="Percentage of Population (%)",
       title="Percentage of College Grads")
```
...
```{r echo=FALSE}
grid.arrange(demog_white_plot,demog_black_plot,demog_na_plot,
             demog_asian_plot,ncol=2)
grid.arrange(demog_pi_plot,demog_latino_plot,demog_sc_plot,demog_grad_plot,
             ncol=2)
```
